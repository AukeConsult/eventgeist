...
<script type="text/javascript">	
	...
	var lastmsgid_read=0;
	var lastnotid_read=0;
    ...
    function prosessMessage(message) {
       ...
       var x = document.createElement("p"); 
          ...
          x.innerHTML = result.eventid;

          document.getElementById("eventid").appendChild(pre);
          
    
    }
    
    function getNoteMissing(lastnoteid) {
    	
    	if(lastmsgid_read<lastnoteid) {
    ...
    function getMsgMissing(lastmsgid) {
...
<body onload="init('127.0.0.1:8080/broker2','football','test1','leif','team1')">
